    ...
    public function bulk_import_data(Request $request)
    {
        ...
        foreach ($collections as $key => $collection) {
            ...
            if ($collection['set_menu'] === "") {
                Toastr::error('Please fill set_menu field of row ' . ($key + 2));
                return back();
            }
            ...
            if (!isset($collection['available_time_starts'])) {
                Toastr::error('Please fill available_time_starts field');
                return back();
            } elseif ($collection['available_time_starts'] === "") {
                Toastr::error('Please fill available_time_starts field of row ' . ($key + 2));
                return back();
            }
            if (!isset($collection['available_time_ends'])) {
                Toastr::error('Please fill available_time_ends field');
                return back();
            } elseif ($collection['available_time_ends'] === "") {
                Toastr::error('Please fill available_time_ends field of row ' . ($key + 2));
                return back();
            }
        }
