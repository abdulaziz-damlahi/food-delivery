                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <span>Order Amount: {{ \App\CentralLogics\Helpers::set_symbol($order['order_amount']) }}</span><br>
...
<script>
    function click_if_alone() {
        ...
        if (Number.parseInt(total) < 2) {
            ...
            $('.checkout_details').html('<div class="text-center"><h1>{{\App\CentralLogics\translate('Redirecting_to_the_payment_page')}}......</h1></div>');
        }
    }
    @if(!$errors->any())
        click_if_alone();
