...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CentralLogics\translate('Branch')}} | {{\App\CentralLogics\translate('Login')}}</title>
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        ...
                        <form id="form-id" action="{{route('branch.auth.login')}}" method="post">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4">{{\App\CentralLogics\translate('Branch Sign in')}}</h1>
                                    <p>{{\App\CentralLogics\translate('Want to login your admin account?')}}
                                        <a href="{{route('admin.auth.login')}}">
                                            {{\App\CentralLogics\translate('Admin Login')}}
                                        </a>
                                    </p>
                                </div>
                            ...
                            <div class="js-form-message form-group">
                                <label class="input-label" for="signinSrEmail">{{\App\CentralLogics\translate('Your email')}}</label>

                                <input type="email" class="form-control form-control-lg" name="email" id="signinSrEmail"
                                       tabindex="1" placeholder="{{\App\CentralLogics\translate('email@address.com')}}" aria-label="email@address.com"
                                       required data-msg="{{\App\CentralLogics\translate('Please enter a valid email address.')}}">
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg"
                                           name="password" id="signupSrPassword" placeholder="{{\App\CentralLogics\translate('8+ characters required')}}"
                                           aria-label="8+ characters required" required
                                           data-msg="{{\App\CentralLogics\translate('Your password is invalid. Please try again.')}}"
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label text-muted" for="termsCheckbox">
                                        {{\App\CentralLogics\translate('Remember me')}}
                                    </label>
                                </div>
                            </div>
                            <!-- End Checkbox -->
                                ...
                                <div class="row p-2">
                                    ...
                                    <div class="col-6 input-icons" style="background-color: #FFFFFF; border-radius: 5px;">
                                        <a onclick="javascript:re_captcha();">
                                            <img src="{{ URL('/branch/auth/code/captcha/1') }}" class="input-field" id="default_recaptcha_id" style="display: inline;width: 90%; height: 75%">
                    ...
                    @if(env('APP_MODE')=='demo')
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10">
                                    <span>{{\App\CentralLogics\translate('Email : mainb@mainb.com')}}</span><br>
                                    <span>{{\App\CentralLogics\translate('Password : 12345678')}}</span>
                                </div>
                                <div class="col-2">
