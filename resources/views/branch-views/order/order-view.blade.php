...
@section('title', \App\CentralLogics\translate('Order Details'))
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                        ...
                        @else
                            <span class="ml-2 ml-sm-3 badge badge-soft-success">
                               <i class="tio-time"></i> {{date('d-M-Y',strtotime($order['delivery_date']))}} {{$order['delivery_time']}}
                            </span>
                        @endif
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3 mb-md-0">
                                                ...
                                                @foreach(json_decode($detail['add_on_ids'],true) as $key2 =>$id)
                                                    ...
                                                    @if($key2==0)
                                                        @if(isset($addon))<strong><u>{{\App\CentralLogics\translate('addons')}} : </u></strong>@endif
                                                    @endif
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="transaction_reference" class="form-control"
                                   placeholder="{{\App\CentralLogics\translate('EX : Code123')}}" required>
                        </div>
                        <!-- End Input Group -->
