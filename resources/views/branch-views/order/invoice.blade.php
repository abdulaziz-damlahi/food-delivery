            ...
            <div class="col-md-12">
                <center>
                    <input type="button" class="btn btn-primary non-printable" onclick="printDiv('printableArea')"
                           value="{{\App\CentralLogics\translate('Proceed, If thermal printer is ready.')}}"/>
            ...
            <div class="col-5">
                <div class="text-center pt-4 mb-3">
                    ...
                    <h5 style="font-size: 16px;font-weight: lighter;line-height: 1">
                        {{\App\CentralLogics\translate('Phone')}} : {{\App\Model\BusinessSetting::where(['key'=>'phone'])->first()->value}}
                    </h5>
                </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-12">
                        @if($order->customer)
                            <h5>
                                {{\App\CentralLogics\translate('Customer Name')}} : <span class="font-weight-normal">{{$order->customer['f_name'].' '.$order->customer['l_name']}}</span>
                            </h5>
                            <h5>
                                {{\App\CentralLogics\translate('Phone')}} : <span class="font-weight-normal">{{$order->customer['phone']}}</span>
                            </h5>
                        @endif
                        @if($order->order_type != 'pos')
                            @php($address=\App\Model\CustomerAddress::find($order['delivery_address_id']))
                            <h5>
                                {{\App\CentralLogics\translate('Address')}} : <span class="font-weight-normal">{{isset($address)?$address['address']:''}}</span>
                            </h5>
                        @endif
                    </div>
                </div>
