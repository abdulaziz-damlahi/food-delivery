            ...
            @if($detail->product)
                ...
                <tr>
                    ...
                    <td class="">
                        ...
                        {{\App\CentralLogics\translate('Discount')}} : {{ \App\CentralLogics\Helpers::set_symbol($detail['discount_on_product']*$detail['quantity']) }}
                    </td>
                    <td style="width: 28%">
...
{{--                <dd class="col-6" style="font-size: 20px">{{ \App\CentralLogics\Helpers::set_symbol($sub_total+$del_c+$total_tax+$add_ons_cost-$order['coupon_discount_amount']) }}</dd>--}}
    ...
    <div class="d-flex flex-row justify-content-between border-top">
        <span>{{\App\CentralLogics\translate('Paid_by')}}: {{\App\CentralLogics\translate($order->payment_method)}}</span>
    </div>
    <span>---------------------------------------------------------------------------------------</span>
