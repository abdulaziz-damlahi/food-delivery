...
@section('title', \App\CentralLogics\translate('Add new product'))
                            ...
                            <div class="card p-4 {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" id="{{$lang}}_name" class="form-control"
                                           placeholder="{{\App\CentralLogics\translate('New Product')}}" {{$lang == 'en'? 'required':''}}
                    ...
                    @else
                        <div class="card p-4" id="{{$default_lang}}-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name[]" class="form-control" placeholder="{{\App\CentralLogics\translate('New Product')}}" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="available_time_ends" class="form-control" value="19:30:00" placeholder="{{\App\CentralLogics\translate('5:45 pm')}}"
                                           required>
                                </div>
                            </div>
                        </div>
            ...
            $.post({
                ...
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('{{\App\CentralLogics\translate("product uploaded successfully!")}}', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {
