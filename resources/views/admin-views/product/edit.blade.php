...
@section('title', \App\CentralLogics\translate('Update product'))
                        ...
                        @foreach(json_decode($language) as $lang)
                            ...
                            <div class="card p-4 {{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" {{$lang == 'en'? 'required':''}} name="name[]" id="{{$lang}}_name" value="{{$translate[$lang]['name']??$product['name']}}" class="form-control" placeholder="{{\App\CentralLogics\translate('New Product')}}" >
                                </div>
                    ...
                    @else
                        <div class="card p-4" id="english-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="name[]" value="{{$product['name']}}" class="form-control" placeholder="{{\App\CentralLogics\translate('New Product')}}" required>
                            </div>
                            ...
                            <div class="col-md-4 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$product['price']}}" min="0" name="price"
                                           ...
                                           placeholder="{{\App\CentralLogics\translate('Ex : 100')}}" required>
                                </div>
                            </div>
                            <div class="col-md-4 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$product['tax']}}" min="0" name="tax"
                                           class="form-control" step="0.01"
                                           placeholder="{{\App\CentralLogics\translate('Ex : 7')}}" required>
                                </div>
                            </div>
                            <div class="col-md-4 col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" value="{{$product['available_time_starts']}}"
                                           ...
                                           placeholder="{{\App\CentralLogics\translate('Ex : 10:30 am')}}" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" value="{{$product['available_time_ends']}}"
                                           name="available_time_ends" class="form-control" placeholder="{{\App\CentralLogics\translate('5:45 pm')}}"
                                           required>
                                </div>
                            </div>
                        </div>
            ...
            $.post({
                ...
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('{{\App\CentralLogics\translate("product updated successfully!")}}', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {
