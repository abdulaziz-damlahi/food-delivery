...
@section('title', \App\CentralLogics\translate('Product Bulk Import'))
        ...
        <div class="row">
            <div class="col-12">
                <div class="jumbotron" style="background: white">
                    ...
                    <p>{{\App\CentralLogics\translate('1. Download the format file and fill it with proper data.')}}</p>

                    <p>{{\App\CentralLogics\translate('2. You can download the example file to understand how the data must be filled.')}}</p>

                    <p>{{\App\CentralLogics\translate('3. Once you have downloaded and filled the format file, upload it in the form below and submit.')}}</p>

                    <p>{{\App\CentralLogics\translate("4. After uploading products you need to edit them and set product's images and choices.")}}</p>

                    <p>{{\App\CentralLogics\translate('5. You can get category and sub-category id from their list, please input the right ids.')}}</p>
                ...
                <form class="product-form" action="{{route('admin.product.bulk-import')}}" method="POST"
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4>{{\App\CentralLogics\translate('Import Products File')}}</h4>
                            <a href="{{asset('assets')}}/product_bulk_format.xlsx" download=""
                               class="btn btn-secondary">{{\App\CentralLogics\translate('Download Format')}}</a>
                        </div>
                        <div class="card-body">
