...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CentralLogics\translate('Admin')}} | {{\App\CentralLogics\translate('Login')}}</title>
...
<main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
        <label class="badge badge-soft-success float-right" style="z-index: 9;position: absolute;right: 0.5rem;top: 0.5rem;">{{\App\CentralLogics\translate('Software version')}} : {{ env('SOFTWARE_VERSION') }}</label>
                ...
                <div class="card card-lg mb-5">
                    ...
                    @if(env('APP_MODE')=='demo')
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10">
                                    <span>{{\App\CentralLogics\translate('Email : admin@admin.com')}}</span><br>
