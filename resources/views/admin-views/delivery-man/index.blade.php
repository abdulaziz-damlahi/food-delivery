...
@section('title', \App\CentralLogics\translate('Add new delivery-man'))
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.delivery-man.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="{{\App\CentralLogics\translate('Ex : ex@example.com')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" placeholder="{{\App\CentralLogics\translate('Ex : 017********')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="identity_number" class="form-control"
                                       placeholder="{{\App\CentralLogics\translate('Ex : DH-23434-LS')}}"
                                       required>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="password" class="form-control" placeholder="{{\App\CentralLogics\translate('Ex : password')}}"
                               required>
                    </div>
