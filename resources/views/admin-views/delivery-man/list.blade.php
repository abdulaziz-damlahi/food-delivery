...
@section('title', \App\CentralLogics\translate('Deliveryman List'))
...
{{--                    <div class="col-0 col-sm-4 col-md-6"></div>--}}
                    <div class="col-12 col-sm-6 text-sm-right text-left">
                        <a href="{{route('admin.delivery-man.add')}}" class="btn btn-primary pull-right"><i
                                class="tio-add-circle"></i> {{\App\CentralLogics\translate('add Deliveryman')}}</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header flex-between">
                        <div class="flex-start">
                            <h5 class="card-header-title">{{\App\CentralLogics\translate('Delivery Man Table')}}</h5>
