...
@section('title', \App\CentralLogics\translate('Update delivery-man'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{\App\CentralLogics\translate('update Deliveryman')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
