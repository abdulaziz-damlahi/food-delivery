...
@section('title', \App\CentralLogics\translate('Point History'))
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm flex-start">
                    <h1 class="page-header-title">{{\App\CentralLogics\translate('Point History')}}</h1>
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="#">{{\App\CentralLogics\translate('Point History')}}</a>
                    </li>
