    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-sm">
                    <h1 class="page-header-title">{{\App\CentralLogics\translate('Subscribed Customers')}}
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="#">{{\App\CentralLogics\translate('Email List')}}</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
                ...
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    @foreach($newsletters as $key=>$newsletter)
                        <tr class="">
                            ...
                            <td>
                                <a href="mailto:{{$newsletter['email']}}?subject={{\App\CentralLogics\translate('Mail from '). \App\Model\BusinessSetting::where(['key' => 'restaurant_name'])->first()->value}}">{{$newsletter['email']}}</a>
                            </td>
                        </tr>
