                    ...
                    <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                        ...
                        <div class="form-group">
                            <label class="input-label"
                                   for="exampleFormControlInput1">{{\App\CentralLogics\translate('restaurant name')}}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label class="input-label"
                                           for="exampleFormControlInput1">{{\App\CentralLogics\translate('opening')}} {{\App\CentralLogics\translate('time')}}</label>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label class="input-label"
                                           for="exampleFormControlInput1">{{\App\CentralLogics\translate('closing')}} {{\App\CentralLogics\translate('time')}}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="form-group">
                                    <label class="input-label"
                                           for="exampleFormControlInput1">{{\App\CentralLogics\translate('Add Language For Data Translation')}}</label>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-12">
                                ...
                                <div class="form-group">
                                    <label>{{\App\CentralLogics\translate('phone verification ( OTP )')}}</label><small style="color: red">*</small>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="form-group">
                                    <label>{{\App\CentralLogics\translate('email verification')}}</label><small
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="form-group">
                                    <label class="input-label"
                                           for="exampleFormControlInput1">{{\App\CentralLogics\translate('delivery charge')}}</label>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body" style="padding: 20px">
                                        <h5 class="text-center">{{\App\CentralLogics\translate('delivery management')}}</h5>
                                        @csrf
                                        <div class="form-group mb-2 mt-2">
                                            <input type="radio" id="shipping_by_distance_status" name="shipping_status" value="1" {{$config['status']==1?'checked':''}}>
                                            <label style="padding-left: 10px">{{\App\CentralLogics\translate('delivery charge by_distance')}}</label>
                                            <br>
                                        </div>
