    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{\App\CentralLogics\translate('App Settings')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="row" style="padding-bottom: 20px">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h2 class="text-center">{{\App\CentralLogics\translate('Android')}}</h2>
                        ...
                        <form
                            ...
                            <div class="form-group mt-4">
                                <div class="my-2">
                                    <label
                                        class="text-dark font-weight-bold">{{ \App\CentralLogics\translate('Enable download link for web footer') }}</label>
                                ...
                                <div class="my-2">
                                    <label class="text-dark"
                                           for="app_store_link">{{ \App\CentralLogics\translate('Download link') }}
                                    </label>
                                ...
                                <div class="my-2">
                                    <label class="text-dark"
                                           for="android_min_version">{{ \App\CentralLogics\translate('Minimum version for force update') }}
                                    ...
                                    <input type="number" min="0" step=".1" id="android_min_version" name="android_min_version"
                                           ...
                                           placeholder="{{ \App\CentralLogics\translate('EX: 4.0') }}">
                                </div>
            ...
            <div class="col-md-6 mt-2 mt-md-0">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h2 class="text-center">{{\App\CentralLogics\translate('IOS')}}</h2>
                        ...
                        <form
                            ...
                            <div class="form-group mt-4">
                                ...
                                <div class="my-2">
                                    <label class="text-dark"
                                           for="ios_min_version">{{ \App\CentralLogics\translate('Minimum version for force update') }}
                                        <i class="tio-info text-danger" data-toggle="tooltip" data-placement="right"
                                           title="{{ \App\CentralLogics\translate("If there is any update available in the admin panel and for that, the previous user app will not work, you can force the customer from here by providing the minimum version for force update. That means if a customer has an app below this version the customers must need to update the app first. If you don't need a force update just insert here zero (0) and ignore it.") }}"></i>
                                    </label>
