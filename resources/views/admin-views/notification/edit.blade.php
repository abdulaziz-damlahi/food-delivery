...
@section('title', \App\CentralLogics\translate('Update Notification'))
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.notification.update',[$notification['id']])}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$notification['title']}}" name="title" class="form-control" placeholder="{{\App\CentralLogics\translate('New notification')}}" required>
                    </div>
                    <div class="form-group">
