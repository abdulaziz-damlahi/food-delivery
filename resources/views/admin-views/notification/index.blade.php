...
@section('title', \App\CentralLogics\translate('Add new notification'))
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.notification.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="{{\App\CentralLogics\translate('New notification')}}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="card">
                    <div class="card-header flex-between">
                        <div class="flex-start">
                            <h5 class="card-header-title">{{\App\CentralLogics\translate('Notification Table')}}</h5>
