...
@section('title', \App\CentralLogics\translate('Update Coupon'))
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{$coupon['title']}}" class="form-control"
                                       placeholder="{{ \App\CentralLogics\translate('New coupon') }}" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                        ...
                        <div class="col-4" id="limit-for-user" style="display: {{$coupon['coupon_type']=='first_order'?'none':'block'}}">
                            <div class="form-group">
                                ...
                                <input type="number" name="limit" value="{{$coupon['limit']}}" class="form-control"
                                       placeholder="{{ \App\CentralLogics\translate('EX: 10') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" class="js-flatpickr form-control flatpickr-custom" placeholder="{{ \App\CentralLogics\translate('Select dates') }}" value="{{date('Y/m/d',strtotime($coupon['start_date']))}}"
                        ...
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="expire_date" class="js-flatpickr form-control flatpickr-custom" placeholder="{{ \App\CentralLogics\translate('Select dates') }}" value="{{date('Y/m/d',strtotime($coupon['expire_date']))}}"
