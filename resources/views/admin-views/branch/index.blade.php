                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" maxlength="255"
                                       placeholder="{{\App\CentralLogics\translate('New branch')}}" required>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-12 col-sm-6 col-md-5">
                            <div class="form-group">
                                ...
                                <input type="number" step="any" name="latitude" class="form-control" maxlength="255"
                                       placeholder="{{\App\CentralLogics\translate('Ex : -132.44442')}}"
                                       required>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-5">
                    ...
                    <div class="table-responsive datatable-custom">
                        <table
                            ...
                            <tr>
                                ...
                                <th style="width: 50%">{{\App\CentralLogics\translate('image')}}</th>
