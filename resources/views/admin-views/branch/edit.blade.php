...
@section('title', \App\CentralLogics\translate('Update Branch'))
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize"><i
                            class="tio-edit"></i> {{\App\CentralLogics\translate('Branch Update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <form action="{{route('admin.branch.update',[$branch['id']])}}" method="post"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{$branch['name']}}" class="form-control"
                                       placeholder="{{\App\CentralLogics\translate('New branch')}}"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="{{$branch['email']}}" class="form-control"
                                       placeholder="{{\App\CentralLogics\translate('EX : example@example.com')}}"
                                       maxlength="255" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <input type="number" name="latitude" value="{{$branch['latitude']}}" class="form-control"
                                       placeholder="{{\App\CentralLogics\translate('Ex : -132.44442')}}" maxlength="255"
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <input type="number" name="longitude" value="{{$branch['longitude']}}"
                                       ...
                                       placeholder="{{\App\CentralLogics\translate('Ex : 94.233')}}"
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="coverage" min="1" value="{{$branch['coverage']}}" max="1000"
                                       class="form-control" placeholder="{{\App\CentralLogics\translate('Ex : 3')}}"
                                    {{$branch_count>1?'required':''}}>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label"
                                       for="exampleFormControlInput1">{{\App\CentralLogics\translate('password')}} <span
                                        class="" style="color: red;font-size: small">* ( {{\App\CentralLogics\translate('input if you want to reset.')}} )</span></label>
                    ...
                    <div class="form-group">
                        <label>{{\App\CentralLogics\translate('Branch Image')}}</label><small style="color: red">* ( {{\App\CentralLogics\translate('ratio')}} 1:1 )</small>
