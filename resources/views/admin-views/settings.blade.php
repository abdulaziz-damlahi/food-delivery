            ...
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('admin.dashboard')}}">
                        <i class="tio-home mr-1"></i> {{\App\CentralLogics\translate('Dashboard')}}
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">{{\App\CentralLogics\translate('Full name')}} <i
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="phoneLabel" class="col-sm-3 col-form-label input-label">{{\App\CentralLogics\translate('Phone')}} <span
                                        class="input-label-secondary">{{\App\CentralLogics\translate('(Optional)')}}</span></label>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h4 class="card-title">{{\App\CentralLogics\translate('Change your password')}}</h4>
                    </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="mb-3">
                                        <input type="password" class="form-control" name="confirm_password"
                                               id="confirmNewPasswordLabel" placeholder="{{\App\CentralLogics\translate('Confirm your new password')}}"
