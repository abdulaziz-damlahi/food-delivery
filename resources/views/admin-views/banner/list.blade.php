...
@section('title', \App\CentralLogics\translate('Banner list'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{\App\CentralLogics\translate('Banner List')}} <span class="text-primary">({{ $banners->total() }})</span></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.banner.add-new')}}" class="btn btn-primary pull-right"><i
                                class="tio-add-circle"></i> {{\App\CentralLogics\translate('Add New Banner')}}</a>
                    </div>
                    <!-- End Header -->
