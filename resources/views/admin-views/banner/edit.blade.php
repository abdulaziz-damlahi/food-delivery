...
@section('title', \App\CentralLogics\translate('Update banner'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{\App\CentralLogics\translate('Update Banner')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{$banner['title']}}" class="form-control"
                                       placeholder="{{\App\CentralLogics\translate('New banner')}}" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
