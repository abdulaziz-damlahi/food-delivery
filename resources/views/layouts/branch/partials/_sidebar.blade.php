            ...
            <div class="navbar-vertical-footer-offset">
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}" aria-label="Front">
                        <img class="navbar-brand-logo" src="{{asset('storage/app/public/restaurant/'.$restaurant_logo)}}"   onerror="this.src='{{asset('assets')}}/admin/img/160x160/img2.jpg'"
                             alt="Logo">

                        <img class="navbar-brand-logo-mini" src="{{asset('storage/app/public/restaurant/'.$restaurant_logo)}}"  onerror="this.src='{{asset('assets')}}/admin/img/160x160/img2.jpg'" alt="Logo">
