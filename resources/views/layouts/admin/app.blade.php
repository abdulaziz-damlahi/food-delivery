                        ...
                        <div class="col-12">
                            <center>
                                <h2 style="color: rgba(96,96,96,0.68)">
                                    <i class="tio-shopping-cart-outlined"></i> {{ \App\CentralLogics\translate('You have new order, Check Please.') }}
                                </h2>
                                <hr>
                                <button onclick="check_order()" class="btn btn-primary">{{ \App\CentralLogics\translate('Ok, let me check') }}</button>
                            </center>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    window.addEventListener('online', function() {
        toastr.success('{{\App\CentralLogics\translate('Became online')}}');
    });
    window.addEventListener('offline', function() {
        toastr.error('{{\App\CentralLogics\translate('Became offline')}}');
    });

    //Internet Status Check (after any event)
    document.body.addEventListener("click", function(event) {
        if(window.navigator.onLine === false) {
            toastr.error('{{\App\CentralLogics\translate('You are in offline')}}');
